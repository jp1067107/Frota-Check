  ...
  ({ className, variant = 'default', size = 'default', icon: Icon, children, ...props }, ref) => {
    return (
      <button
        ref={ref}
        className={cn(
          "inline-flex items-center justify-center rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 text-center",
          {
            ...
            'min-h-[36px] px-4 py-2': size === 'default',
            'min-h-[32px] py-1 rounded-md px-3 text-[10px] uppercase font-bold tracking-widest': size === 'sm',
            'min-h-[40px] py-2 rounded-md px-8 text-base': size === 'lg',
            'h-9 w-9': size === 'icon',
